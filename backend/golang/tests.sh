time go run main.go \
    -statement="MERGE (spotifyartist0A7g2YbCA9FlyZvAG6VmKP:Author {uri: 'spotify:artist:0A7g2YbCA9FlyZvAG6VmKP'}) set spotifyartist0A7g2YbCA9FlyZvAG6VmKP.name = \"The LOX\"
...
MERGE (spotifyartist5Matrg5du62bXwer29cU5T)-[:FEATS_WITH {name:\"Hood Blues (feat. Westside Gunn, Benny The Butcher & Conway The Machine) - Acapella\", uri:'spotify:track:4hgLCh56N154sGYCxNmc54'}]->(spotifyartist67gqUXxHedeUGDTxwBzdjS)" \
    --uri=neo4j+s://80878a09.databases.neo4j.io -user=neo4j -p=SlZ6b85XMAqbnpkIlOOCgzQS5SSBHrWgGSCur-u99nM
