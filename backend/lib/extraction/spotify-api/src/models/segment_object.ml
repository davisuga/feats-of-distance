...
type t = {
  ...
  loudness_start : float option; [@default None]
  ...
  loudness_max : float option; [@default None]
  ...
  loudness_max_time : float option; [@default None]
  (* The offset loudness of the segment in decibels (dB). This value should be equivalent to the loudness_start of the following segment. *)
  loudness_end : float option; [@default None]
